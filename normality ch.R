...
shapiro.test(x = aov_residuals )  ## p < 0.05 indicates the residuals are not normal, (the data is non parametric)
                                  ## and the kruskal-wallis test should be used instead of ANOVA
...
kt3
pairwise.wilcox.test(Site3$response, Site3$Sal_treat, p.adjust = "bonferroni")
